...
public class Application implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Image chelseaLogo = new Image(filip, new URL("https://upload.wikimedia.org/wikipedia/en/thumb/c/cc/Chelsea_FC.svg/768px-Chelsea_FC.svg.png"), "Chelsea Logo", new Date());
        imageRepository.save(chelseaLogo);

        Image arsenalLogo = new Image(filip, new URL("https://s-media-cache-ak0.pinimg.com/736x/b3/62/68/b362686170e30ca7ee9a0f9ebe4a2d1d.jpg"), "Arsenal Logo", new Date());
